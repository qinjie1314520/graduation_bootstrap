'use strict';
if(require('.staging/core-js-03f9c524/modules/$.descriptors')){
  var LIBRARY             = require('.staging/core-js-03f9c524/modules/$.library')
    , global              = require('.staging/core-js-03f9c524/modules/$.global')
    , $                   = require('.staging/core-js-03f9c524/modules/$')
    , fails               = require('.staging/core-js-03f9c524/modules/$.fails')
    , $export             = require('.staging/core-js-03f9c524/modules/$.export')
    , $typed              = require('.staging/core-js-03f9c524/modules/$.typed')
    , $buffer             = require('.staging/core-js-03f9c524/modules/$.buffer')
    , ctx                 = require('.staging/core-js-03f9c524/modules/$.ctx')
    , strictNew           = require('.staging/core-js-03f9c524/modules/$.strict-new')
    , propertyDesc        = require('.staging/core-js-03f9c524/modules/$.property-desc')
    , hide                = require('.staging/core-js-03f9c524/modules/$.hide')
    , redefineAll         = require('.staging/core-js-03f9c524/modules/$.redefine-all')
    , isInteger           = require('.staging/core-js-03f9c524/modules/$.is-integer')
    , toInteger           = require('.staging/core-js-03f9c524/modules/$.to-integer')
    , toLength            = require('.staging/core-js-03f9c524/modules/$.to-length')
    , toIndex             = require('.staging/core-js-03f9c524/modules/$.to-index')
    , toPrimitive         = require('.staging/core-js-03f9c524/modules/$.to-primitive')
    ...
    , isIterable          = require('.staging/core-js-03f9c524/modules/core.is-iterable')
    , getIterFn           = require('.staging/core-js-03f9c524/modules/core.get-iterator-method')
    , wks                 = require('.staging/core-js-03f9c524/modules/$.wks')
    , createArrayMethod   = require('.staging/core-js-03f9c524/modules/$.array-methods')
    , createArrayIncludes = require('.staging/core-js-03f9c524/modules/$.array-includes')
    , speciesConstructor  = require('.staging/core-js-03f9c524/modules/$.species-constructor')
    , ArrayIterators      = require('.staging/core-js-03f9c524/modules/es6.array.iterator')
    , Iterators           = require('.staging/core-js-03f9c524/modules/$.iterators')
    , $iterDetect         = require('.staging/core-js-03f9c524/modules/$.iter-detect')
    , setSpecies          = require('.staging/core-js-03f9c524/modules/$.set-species')
    , arrayFill           = require('.staging/core-js-03f9c524/modules/$.array-fill')
    , arrayCopyWithin     = require('.staging/core-js-03f9c524/modules/$.array-copy-within')
